            ...
            <article key={e.slug} className={`grid md:grid-cols-2 gap-8 items-center ${i % 2 === 1 ? "md:[&>img]:order-2" : ""}`}>
              ...
              <div>
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  ...
                  <Link to="/events/$slug" params={{ slug: e.slug }} className="btn-outline" resetScroll>
                    Enter Now
                  </Link>
                </div>
                <Link to="/events/$slug" params={{ slug: e.slug }} className="mt-3 inline-flex items-center gap-1 text-sm text-primary font-semibold hover:underline" resetScroll>
