...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Terms and conditions for entry into our cycling sportives." },
    ],
  }),
  component: () => (
    <PolicyPage title="Terms & Conditions" updated="June 2026">
      <p>By entering one of our events you agree to the following terms.</p>
      ...
      <ul>
        ...
        <li>Between 30–60 days you may transfer your entry to another rider or another event in our calendar</li>
        <li>No refunds or transfers are available within 30 days of the event</li>
      </ul>

      <h2>Cancellation by the organisers</h2>
      ...
      <h2>Liability</h2>
      <p>Cycling on the open road carries risks. You participate at your own risk. The organisers are not liable for personal injury, loss or damage except where caused by our negligence.</p>

      <h2>Rules of the road</h2>
      <p>All our events take place on open roads. You must obey the Highway Code at all times. Marshals are there to guide, not to stop traffic.</p>
    </PolicyPage>
  ),
});
